...
def plot_accuracies(train_accuracies, test_accuracies, n_estimators_options, train_label='Train Accuracy'):
    ...
    plt.legend()
    plt.show()
    plt.plot(n_estimators_options, train_accuracies, label=train_label, color='orange')
    plt.xlabel('Number of Estimators')
...
def get_scores(n_estimators, X_train, y_train, X_test, y_test):
...
def run_boosting(X_train, y_train, X_test, y_test):
    ...
    for n_estimators in n_estimators_options:
        train_accuracy, test_accuracy = get_scores(n_estimators, X_train, y_train, X_test, y_test)
